...
const Menu = () => {
    return (
        ...
        <div className=" h-auto w-30 bg-white flex-col  ">
            ...
            <div className=" rounded-lg cursor-pointer m-2 hover:bg-slate-100 flex justify-start">
                ...
                <span className="p-2 font-semibold">Music</span>
            </div>

            <div className=" rounded-lg cursor-pointer m-2 hover:bg-slate-100 flex justify-start">
                <span className="p-2"><svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 21 16">
                ...
                <span className="p-2 font-semibold">Gaming</span>
            </div>
            <div className=" rounded-lg cursor-pointer m-2 hover:bg-slate-100 flex justify-start">
                <span className="p-2"><svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 5h18M1 5v14h18V5M1 5V1h18v4M5 5l3-4m1.215 4 3-4m1.215 4 3-4M8.007 8v8l5.416-4-5.416-4Z" />
                </svg></span>
                <span className="p-2 font-semibold">Movies</span>
            </div>
            <div className=" rounded-lg cursor-pointer m-2 hover:bg-slate-100 flex justify-start">
                <span className="p-2"><svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                ...
                <span className="p-2 font-semibold">News</span>
            </div>
            <div className=" rounded-lg cursor-pointer m-2 hover:bg-slate-100 flex justify-start">
                <span className="p-2"><svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 18">
                ...
                <span className="p-2 font-semibold">Live</span>
            </div>
            <div className=" rounded-lg cursor-pointer m-2 hover:bg-slate-100 flex justify-start">
                <span className="p-2"><svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="p-2 font-semibold">Settings</span>
            </div>
            <div className=" rounded-lg cursor-pointer m-2 hover:bg-slate-100 flex justify-start">
                <span className="p-2"><svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 20">
                ...
                <span className="p-2 font-semibold">Report</span>
            </div>
            <div className=" rounded-lg cursor-pointer m-2 hover:bg-slate-100 flex justify-start">
                <span className="p-2"><svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                ...
                <span className="p-2 font-semibold">Help </span>
            </div>
            <div className=" rounded-lg cursor-pointer m-2 hover:bg-slate-100 flex justify-start">
                <span className="p-2"><svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                ...
                <span className="p-2 font-semibold">Light Mode </span>
            </div>
        </div>
