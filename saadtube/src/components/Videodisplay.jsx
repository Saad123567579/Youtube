    ...
    return (
        <div className="flex justify-center absolute">
            <div className="m-10 flex-col">
                <iframe width="860" height="515" src="https://www.youtube.com/embed/yIaXoop8gl4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                <h1 className="w-3/4 font-semibold">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Enim placeat aperiam provident quos ipsa doloribus aliquam beatae quas magnam ratione?</h1>
                <div className="flex items-center w-3/4 justify-between">
                    <div>
                        <h1>34532 views . June 12, 2020</h1>
                    </div>
                ...
                <div className=" w-4/5 h-auto flex justify-start ">
                    <div><img alt="img" src="https://images.pexels.com/photos/17693898/pexels-photo-17693898/free-photo-of-peek-a-boo.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load" className="rounded-full w-20 h-20 p-2" /></div>
                    <div className="flex flex-col justify-center">
                        <h1 className="font-bold">Lama dev</h1>
